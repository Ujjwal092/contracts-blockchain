...
//         uint256 initialSupply  = 1000*(10**uint256(_decimals));//decimal yha pr 18 h neeche dekho
//         _totalSupply = initialSupply; //total supply of the token is 1000
...
//         require(_to != address(0), "Cannot mint to adress zero");
//         require(amount > 0, "Amount must be greater than 0");
//         require(balances[owner] + amount >= balances[owner], "Amount overflow");
...
contract UjjwalCoin is ERC20, Ownable {
    constructor(address initialOwner)
     ERC20("UjjwalCoin", "UJC")
